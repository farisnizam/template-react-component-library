  ...
  return (
    <>
      ...
      <StatesLoadingButton
        ...
        successText="Success!"
        disabled={false}
        onClickAsync={() => new Promise((resolve) => setTimeout(resolve, 2000))}
      />
    </>
  );
};
